...
const routeReportes = require('./rutas/ruta.reportes');
const routePdf = require('./rutas/ruta.pdf');
const routeNosotros = require('./rutas/ruta.nosotros');
...
app.use ('/', routeReportes);
app.use ('/', routePdf);
app.use ('/', routeNosotros);
// archivos estaticos
