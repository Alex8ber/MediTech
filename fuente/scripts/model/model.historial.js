...
const historial = {
    ...
    actualizar_examen_fisico(id, peso, altura, presion, frecuencia, respiratoria, imc, alergias) {
    return new Promise((resolve, reject) => {
        const sql = `
            ...
            WHERE Paciente_ID = ?
        `;
        conexion.query(sql, [peso, altura, presion, frecuencia, respiratoria, imc, alergias, id], (error, resultados) => {
